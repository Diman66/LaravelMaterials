                    ...
                    @forelse ($tags as $tag)
                        <li class="list-group-item list-group-item-action d-flex justify-content-between">
                            ...
                            <span class="text-nowrap">
                                ...
                                <button type="submit" form="delete{{ $tag->id }}" class="btn btn-link p-0 border-0 align-baseline" >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <form action="{{ route('tags.destroy', $tag->id) }}" method="post" id="delete{{ $tag->id }}">
                                    @csrf
                                    @method('delete')
                                </form>    
                            </span>
