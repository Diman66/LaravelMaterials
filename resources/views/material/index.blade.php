...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <form action="{{ route('materials.search') }}">
                @csrf
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-nowrap text-end">
                        ...
                        <button type="submit" form="delete{{ $material->id }}" class="btn btn-link p-0 border-0 align-baseline" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <form action="{{ route('materials.delete', $material->id) }}" method="post" id="delete{{ $material->id }}">
                            @csrf
                            @method('delete')
                        </form>   
                    </td>
